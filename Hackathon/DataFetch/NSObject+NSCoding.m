...
- (NSMutableDictionary *)propertiesForClass:(Class)klass {
    ...
    [[NSCodingClassPropertyCache sharedInstance] addClassPropertyToCache:results forClass:[self class]];
    
    return results;
}

- (NSDictionary *)properties {
    NSDictionary *_cachePropertyDictionary = [[NSCodingClassPropertyCache sharedInstance] getClassPropertyFromCache:[self class]];
