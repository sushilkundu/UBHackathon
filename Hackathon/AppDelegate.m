...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.viewController = [[IIViewDeckController alloc] initWithCenterViewController:mainViewController rightViewController:rightViewController];
    ...
    if (FBSession.activeSession.state == FBSessionStateCreatedTokenLoaded)
    {
        ...
        loginView.frame = CGRectOffset(loginView.frame, (controller.view.center.x - (loginView.frame.size.width / 2)), 160);
